...
import com.example.SI_KRS.CreateMahasiswaActivity;
...
public class MahasiswaAdapter extends RecyclerView.Adapter<MahasiswaAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.cv_mahasiswa,parent,false); //
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{ //utk menghubungkan dari txt
        ...
        public ViewHolder(View view){
            ...
            txtNamaMhs = view.findViewById(R.id.txtNama);
            txtEmailMhs = view.findViewById(R.id.txtEmail);
            txtAlamatMhs = view.findViewById(R.id.txtAlamat);
            imgFoto = view.findViewById(R.id.fotoMahasiswa);
            cv = view.findViewById(R.id.cardMahasiswa);
        }
    }
}
